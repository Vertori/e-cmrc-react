      ...
      <div className='w-full min-h-[150px] flex items-center gap-x-4'>
        ...
        <div className='w-full flex flex-col '>
          ...
          <div className='flex gap-x-2 h-[36px] text-sm'>
            ...
            {/* item price */}
            <div className='flex flex-1 items-center justify-around'>{price} zł</div>
            {/* final price */}
            <div className='flex flex-1 justify-end items-center text-primary font-medium'>{`${parseFloat(price * amount).toFixed(2)} zł`}</div>
          </div>
        </div>
      </div>
    </div>
